...
namespace tvlm{
    ...
    inline Program *TargetProgramFriend::getProgram(TargetProgram *p) const {
        return p->program_;
    }
...
//        return program.call_patches_;
    ...
    TargetProgramFriend::getAllocLmapping(TargetProgram & program)const{
        return program.allocLmapping_;
    }
