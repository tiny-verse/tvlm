...
namespace tvlm{
    ...
    class ColoringDeclarationAnalysis : public ILVisitor, public TargetProgramFriend {
    public:
        using Declaration = VirtualRegisterPlaceholder;

        ColoringDeclarationAnalysis(TargetProgram * prog):program_(prog){}
        virtual ~ColoringDeclarationAnalysis() = default;
//        ILUsageVisitor(): ILVisitor(), result_(){}
    ...
    protected:
        ...
        void visitHelper(const Instruction * ins);
